#ifndef DATAFORMATS_SISTRIPDETSETVECTORCOMPRESSEDCLUSTER_H
#define DATAFORMATS_SISTRIPDETSETVECTORCOMPRESSEDCLUSTER_H
...
class SiStripDetSetVectorCompressedCluster {
public:
  ...
  SiStripDetSetVectorCompressedCluster();

  SiStripDetSetVectorCompressedCluster(std::vector<std::pair<uint16_t, bool>>&, std::vector<float>&,std::vector<uint8_t>& );
...
#endif  // DATAFORMATS_SISTRIPDETSETVECTORCOMPRESSEDCLUSTER_H
