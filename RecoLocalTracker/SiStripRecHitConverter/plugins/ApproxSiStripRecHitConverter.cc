...
{
  clusterProducer = consumes<edmNew::DetSetVector<SiStripApproximateClusterv2> >(conf.getParameter<edm::InputTag>("ClusterProducer"));
...
void ApproxSiStripRecHitConverter::
produce(edm::Event& e, const edm::EventSetup& es)
{
  edm::Handle<edmNew::DetSetVector<SiStripApproximateClusterv2> > clusters;
